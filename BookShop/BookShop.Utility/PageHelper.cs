...
namespace BookShop.Utility
{
    ...
    public static class PagerHelper
    {
        ...
        public static string RendPage(string format, int totalPages, int current = 1, int showCount = 9, string ulContainerClass = "pagination", string activeLiClass = "active", char separator = '@')
        {
            ...
            if (current != 1)
            {
                pager.AppendFormat("\t<li><a href=\"{1}{0}{2}\">«</a></li>\r\n", current - 1, prefix, suffix);
                //pager.Append(string.Format("\t<li><a href=\"{1}{0}{2}\">上一页</a></li>\r\n", current - 1, prefix, suffix));
            }
            if (beginNum != 1)
            {
