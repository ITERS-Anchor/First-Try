...
WHERE [Id] = @Id";
        ...
        public IEnumerable<Categories> QueryList(int index, int size, object wheres, string orderField, bool isDesc = true)
        {
            ...
            var sql = SqlHelper.GenerateQuerySql("Categories", new[] { "Id", "Name","ParentId"}, index, size, whereBuilder.ToString(), orderField, isDesc);
        ...
        #region 查询单个模型实体 +Categories QuerySingle(int id)
        /// <summary>
        /// 查询单个模型实体
        /// </summary>
        ...
        {
            const string sql = "SELECT TOP 1 [Id], [Name],[ParentId] FROM [dbo].[Categories] WHERE [Id] = @Id";
