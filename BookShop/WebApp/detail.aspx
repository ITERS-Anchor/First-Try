<%@ Page Title="" Language="C#" MasterPageFile="~/shared/Site.Master" AutoEventWireup="true" CodeBehind="detail.aspx.cs" Inherits="WebApp.detail" %>
     ...
     <!-- 详细页开始 -->
        ...
        <div class="row">
            ...
            <div id="content" class="col-lg-10">
                <div class="item-meta">
                    <h1 class="meta-tit"><%= CurrentBook.Title %></h1>
                    <div class="meta-situ">
                        <div class="meta-magnifier pull-left">
                            <img src="/content/books/<%= CurrentBook.ISBN %>.jpg" />
                        </div>
                        <div class="meta-show pull-right">
                            <h2 class="meta-maintit"><%= CurrentBook.Title %></h2>
                            ...
                            <div class="meta-reveal mb10">
                                <ul>
                                    ...
                                    <li class="reveal-sow rev-text-1">￥<%=CurrentBook.UnitPrice+20 %></li>
                                    <li class="reveal-tit">现价：</li>
                                    <li class="reveal-sow rev-text-2">￥<%=CurrentBook.UnitPrice %> <b class="rev-text-3 ml10">返积分：20</b> <b class="rev-text-4 ml10"><a href="">什么积分？</a></b></li>
                            ...
                            <div class="meta-btn">
                                <div class="quantity mb10">购买数量：<span class="ui-spinner"><input type="text" value="0" aria-valuenow="0" autocomplete="off"><a class="ui-spinner-button ui-spinner-up" tabindex="-1"><span class="ui-icon">▲</span></a><a class="ui-spinner-button ui-spinner-down" tabindex="-1"><span class="ui-icon">▼</span></a></span>(库存21件)</div>
                        ...
                        <div class="tab-content p15">
                                    ...
                                    <div class="user">
                                        <div class="user-avatar">
                                            <a href="" target="_blank">
                                                <img alt="唯***8" src="assets/img/admin.png" data-original="" style="display: inline;" /></a>
                                        </div>
                                        <div class="user-name">
                            ...
                            <div class="tab-pane" id="good">
                                 <div class="rev-list">
                                    <div class="user">
                                        <div class="user-avatar">
                                            <a href="" target="_blank"><img alt="唯***8" src="assets/img/admin.png" data-original="" style="display: inline;" /></a>
                                        </div>
                                        <div class="user-name">
                                            <a href="" target="_blank">唯***8</a>
                                        </div>
                ...
                <div class="item-after" id="after">
                    ...
                    <div class="p15">
                        <p class="lh200">
                            <b>服务承诺： </b>
                            <br />
                            商城向您保证所售商品均为正品行货，商城自营商品自带机打发票，与商品一起寄送。凭质保证书及商城商城发票，可享受全国联保服务（奢侈品、钟表除外；奢侈品、钟表由商城联系保修，享受法定三包售后服务），与您亲临商场选购的商品享受相同的质量保证。商城商城还为您提供具有竞争力的商品价格和运费政策，请您放心购买！<br />
                            <br />
