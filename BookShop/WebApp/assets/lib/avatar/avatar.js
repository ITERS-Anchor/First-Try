 ...
 * 头像编辑器对象
 * @param String 渲染容器ID
 * @param Object flash程序参数
 * @param Number 元素高度
 * @param Number 元素宽度
 * @param Callback 回调函数
 */
function AvatarEditor() {
    var id = 'avatar_editor';		                                // 渲染容器ID
    var rootPath = '';                           // SWF文件所在根路径
    var file = rootPath + 'avatar.swf';		                        // flash文件的路径
    var version = "10.1.0";						                    // 播放该flash所需的最低版本
    var expressInstall = rootPath + 'expressInstall.swf';			// expressInstall.swf的路径
    var width = 630;							                    // flash文件的宽度
    var height = 430;							                    // flash文件的高度
    var container = id;							                    // 装载flash文件的容器(如div)的id
    var flashvars = {};                                             // flash参数
    ...
    var swf;
    swfobject.embedSWF(file, container, width, height, version, expressInstall, vars, params, attributes, function (e) {
        swf = e.ref;
